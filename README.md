...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/rucif/nft-market?style=round)
...
![GitHub](https://img.shields.io/github/license/rucif/nft-market?style=round)
...
This project relies on [NFT Contracts](https://github.com/rucif/nft-contracts) package and [NFT Lambda Service](https://github.com/rucif/nft-market-service) for serving the metadata
...
It's been transferred to the [NFT Lambda Service](https://github.com/rucif/nft-market-service) repository.
